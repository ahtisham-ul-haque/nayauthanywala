...
<Text style={{color:Black,fontSize:17,margin:10}}>Recent Payees</Text>
<FlatList
  data={DATA}
  horizontal
  renderItem={({ item }) => {
    return (
      ...
      <Text style={{ color: Black, fontSize: 16, marginTop: 5,textAlign:'center',width:'60%',}}>
...
/>
<View style={{marginHorizontal:10,height:50,marginVertical:10,flexDirection:'row',alignItems:"center",justifyContent:'space-between'}}>
<TouchableOpacity
...
style={{justifyContent:"space-between",flexDirection:'row',margin:10,alignItems:"center"}}>
    <View style={{width:'80%',flexDirection:'row'}}>
        <View style={{}}>
<AntDesign name='retweet' size={28} color={Black}/>
        </View>
        <View style={{alignItems:"center",justifyContent:'center',marginLeft:10}}>
            <Text style={{color:Black,fontSize:16,}}>Make a payment or transfer</Text>
        </View>
    </View>
    <View style={{}}>
...
<View style={{justifyContent:"space-between",flexDirection:'row',margin:10,alignItems:"center"}}>
    <View style={{width:'80%',flexDirection:'row'}}>
        <View style={{}}>
<AntDesign name='filter' size={28} color={Black}/>
        </View>
        <View style={{alignItems:"center",justifyContent:'center',marginLeft:10}}>
            <Text style={{color:Black,fontSize:16,}}>Deposit a cheque</Text>
        </View>
    </View>
    <View style={{}}>
...
<Icon name='aperture-outline' size={28} color={'red'}/>
        ...
        <View style={{alignItems:"center",justifyContent:'center',marginLeft:10}}>
            <Text style={{color:Black,fontSize:16,}}>Pay buy Bank app</Text>
        </View>
    </View>
    <View style={{}}>
...
<AntDesign name='codepen' size={28} color={Black}/>
        ...
        <View style={{alignItems:"center",justifyContent:'center',marginLeft:10}}>
            <Text style={{color:Black,fontSize:16,}}>International Payment tracker</Text>
        </View>
    </View>
    <View style={{}}>
...
<Icon name='arrow-up-circle-outline' size={28} color={Black}/>
        ...
        <View style={{alignItems:"center",justifyContent:'center',marginLeft:10}}>
            <Text style={{color:Black,fontSize:16,}}>Manage  Payment Limit</Text>
        </View>
    </View>
    <View style={{}}>
...
<View style={{marginVertical:20}}>
    <Text style={{marginHorizontal:15,color:Black,fontSize:16}}>Global money</Text>
</View>
<View style={{backgroundColor:White,marginVertical:10}}> 
<View style={{justifyContent:"space-between",flexDirection:'row',margin:10,alignItems:"center"}}>
    <View style={{width:'80%',flexDirection:'row'}}>
...
<Icon name='aperture-outline' size={28} color={Black}/>
        ...
        <View style={{alignItems:"center",justifyContent:'center',marginLeft:10}}>
            <Text style={{color:Black,fontSize:16,}}>Send money internationally</Text>
        </View>
    </View>
    <View style={{}}>
...
<Icon name='person-outline' size={28} color={Black}/>
        ...
        <View style={{alignItems:"center",justifyContent:'center',width:'100%'}}>
            <Text style={{color:Black,fontSize:16,lineHeight:23}}>Pay or Manage Global Money Payees</Text>
        </View>
    </View>
    <View style={{}}>
...
<Icon name='globe-outline' size={28} color={Black}/>
        ...
        <View style={{alignItems:"center",justifyContent:'center',marginLeft:10}}>
            <Text style={{color:Black,fontSize:16,}}>Add convert or withdraw</Text>
        </View>
    </View>
    <View style={{}}>
