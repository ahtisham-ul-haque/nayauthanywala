      ...
      {/* Header Section */}
        ...
        <StatusBar backgroundColor={White}/>
         <View style={{flexDirection:'row',paddingVertical:10,height:40,backgroundColor:White}}>
                     ...
                     <Text style={{color:'#000',textAlign:'center',width:'80%',fontSize:18}}>Great British pounds</Text>
                     </View>
                </View>
...
>
    <TouchableOpacity style={{alignSelf:'flex-end',marginHorizontal:10,marginVertical:10}}>
    <Ionicons name='close-outline' color={Black} size={22}/>
    </TouchableOpacity>
    <TouchableOpacity style={{margin:10,marginHorizontal:15,marginTop:20,flexDirection:'row',justifyContent:'space-between',}}>
<View style={{flexDirection:'row',alignItems:'center'}}>
<Ionicons name='document-outline' color={Black} size={22}/>
<Text style={{color:Black,paddingLeft:10,fontSize:15}}>View statements</Text>
</View>
<View style={{}}>
<Ionicons name='chevron-forward-outline' color={Black} size={22}/>
</View>
    </TouchableOpacity>
    <TouchableOpacity style={{margin:10,marginHorizontal:15,flexDirection:'row',justifyContent:'space-between',}}>
<View style={{flexDirection:'row',alignItems:'center'}}>
<Ionicons name='card-outline' color={Black} size={22}/>
<Text style={{color:Black,paddingLeft:10,fontSize:15}}>Manage card</Text>
</View>
<View style={{}}>
<Ionicons name='chevron-forward-outline' color={Black} size={22}/>
</View>
    ...
    style={{margin:10,marginHorizontal:15,flexDirection:'row',justifyContent:'space-between',}}>
<View style={{flexDirection:'row',alignItems:'center'}}>
<Ionicons name='cog-outline' color={Black} size={22}/>
<Text style={{color:Black,paddingLeft:10,fontSize:15}}>Manage account</Text>
</View>
<View style={{}}>
<Ionicons name='chevron-forward-outline' color={Black} size={22}/>
</View>
...
<Text style={{color:Black,paddingLeft:10,fontSize:15}}>View and share account details</Text>
</View>
<View style={{}}>
<Ionicons name='chevron-forward-outline' color={Black} size={22}/>
</View>
  ...
  {/* Content inside the RBSheet */}
      ...
      <View style={styles.transactionsContainer}>
        ...
        <View style={styles.tabsContainer}>
          <Text style={[styles.tab, styles.activeTab]}>GBP</Text>
          <Text style={styles.tab}>All</Text>
        </View>
        <View style={styles.noTransactionsContainer}>
          <Ionicons name="swap-horizontal-outline" size={50} color="#000" style={styles.placeholderIcon} />
          <Text style={styles.noTransactionsText}>There are no transactions to display.</Text>
        </View>
      </View>
    </View>
    </SafeAreaView>
