...
<View style={{padding:20,width:'50%'}}>
  ...
  <Text style={{color:Black,fontSize:16}}>40-16-64 01757407</Text>
</View>
<View style={{flexDirection:'row',}}>
<View>
<Text style={{color:Black,fontSize:16}}>£0.57</Text>
</View>
...
<View style={{padding:20}}>
  ...
  <Text style={{color:Black,fontSize:16}}> 40-12-98 81051709</Text>
</View>
<View style={{flexDirection:'row',}}>
<View>
<Text style={{color:Black,fontSize:16}}>£4.92</Text>
</View>
<View style={{marginHorizontal:20,borderWidth:2,height:20,width:20,borderRadius:20}}>
</View>
</View>
